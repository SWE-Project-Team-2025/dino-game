...
class DayNightEnvironment:
    ...
    def _draw_night_objects(self, screen, night_opacity):
        ...
        moon_angle = (self.cycle.cycle_position * 2 * math.pi + math.pi) % (2 * math.pi)  # Offset by π so moon rises at night
        moon_x = self.screen_width * (0.5 + 0.4 * math.cos(moon_angle))  # Moon moves horizontally across screen
